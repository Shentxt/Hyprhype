            ...
            children: [
                Widget.Box({
                    children: [
                        ...
                        Widget.Button({
                        valign: 'center',
                        onClicked: 'bash -c "wezterm start --always-new-process -e $SHELL -c \'paru -Syu --noconfirm\'"',
                        onSecondaryClick: 'bash -c "wezterm start --always-new-process -e $SHELL -c \'browsh https://archlinux.org/packages/\'"',
                        child: Widget.Icon(icons.update),
                        }),
                        Widget.Button({
                            valign: 'center',
                            onClicked: 'bash -c ~/.config/hypr/scripts/gamemode',
                            onSecondaryClick: 'bash -c "wezterm start --always-new-process -e $SHELL -c \'browsh https://www.protondb.com/explore\'"',
