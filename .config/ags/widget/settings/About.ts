...
export default () => {
    ...
    systemInfo.memory = Utils.exec("bash -c \"free -h | awk 'NR==2 {print $2}' | xargs\"") + "/" + Utils.exec("bash -c \"free -h | awk 'NR==2 {print $7}' | xargs\""); 
    systemInfo.disksize = Utils.exec("bash -c \"df -h / | awk 'NR==2 {print $2}'\""); 
    ...
    return Widget.Box(
        ...
        Widget.Box(
            ...
            Widget.Label({
                label: `Kernel: ${systemInfo.kernel}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            Widget.Label({
                label: `Distro: ${systemInfo.distro}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            Widget.Label({
                label: `WM: ${systemInfo.window}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            Widget.Label({
                label: `Display: ${systemInfo.server}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            ...
            Widget.Label({
                label: `Memory: ${systemInfo.memory}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            Widget.Label({
                label: `Disk: ${systemInfo.disksize}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            ...
            Widget.Label({
                label: `Icon: ${systemInfo.icon}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            Widget.Label({
                label: `Cursor: ${systemInfo.cursor}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            Widget.Label({
                label: `Colors: ${systemInfo.gtk}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
            Widget.Label({
                label: `Font: ${systemInfo.font}`,
                class_name: "info-label",
                css: `font-size: ${fontSize}; margin-bottom: ${marginBottom};`,
            }),
